...
<link href={{asset('assests/css/clean-blog.min.css')}} rel="stylesheet">
...
<script src={{assets('assests/vendor/jquery/jquery.min.js')}}></script>
<script src={{asset('assests/vendor/bootstrap/js/bootstrap.bundle.min.js') }}></script>

<!-- Custom scripts for this template -->
<script src={{asset('assests/js/clean-blog.min.js')}}></script>
</body>
</html>
